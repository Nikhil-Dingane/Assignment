...
class SearchInFile
{
	...
	//This method is used to display the count unique word as per file

	public void coundWords() throws Exception
	{
		String buffer = null;
		...
		for(File file:filelist)
		{
			...
			while((buffer=br.readLine())!=null)
			{
				...
				for(String word:tokens)
				{
					...
					{
						worddictionary.put(word,worddictionary.get(word)+1);
					}
					else
					{
